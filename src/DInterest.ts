...
export function handleEDeposit(event: EDeposit): void {
  ...
  deposit.funder = "NULL";
  deposit.earlyWithdraw = false;
  deposit.withdrawTXHash = "NULL";
  deposit.withdrawTXBlockNumber = ZERO_INT;
  deposit.mphFunderRewardMultiplier = pool.mphFunderRewardMultiplier;
...
export function handleEWithdraw(event: EWithdraw): void {
  ...
  deposit.withdrawTXHash = event.transaction.hash.toHexString();
  deposit.withdrawTXBlockNumber = event.block.number;
...
export function handleEFund(event: EFund): void {
  ...
  funding.creationTXhash = event.transaction.hash.toHexString();
  ...
  for (
    ...
    if (deposit.active) {
      ...
      deposit.funder = funder.id;
            log.warning("MPH estimate debug {} {} {} {} {} {} {}", [
        deposit.id.toString(),
        funding.creationTimestamp.toString(),
        deposit.maturationTimestamp.toString(),
        pool.mphFunderRewardMultiplier.toString(),
        deposit.amount.toString(),
        deposit.maturationTimestamp.toString(),
        funding.creationTimestamp.toString(),
      ]);
      deposit.funderMPHRewardEstimated = funding.creationTimestamp.lt(
        deposit.maturationTimestamp
      )
        ? pool.mphFunderRewardMultiplier
            .times(deposit.amount)
